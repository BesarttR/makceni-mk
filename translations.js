...
"home.share.message": " Цени на гориво — makceni.mk\n\n{label}: {price} ден/л\n{changeText}\n\nПровери ги сите цени: https://makceni.mk",
  ...
  ekstra:   " -3.5 ден од полноќ",
  mazut:    " -2.1 ден од полноќ",
},
...
priceChange: {
  ...
  ekstra:   " -3.5 den nga mesnata",
  mazut:    " -2.1 den nga mesnata",
},
...
priceChange: {
  ...
  ekstra:   " -3.5 den from midnight",
  mazut:    " -2.1 den from midnight",
},
      units: { perL: "den/L", perKg: "den/kg" },
      todayBadge:    "TODAY",
...
priceChange: {
  ...
  ekstra:   " -3.5 den geceyarısından itibaren",
  mazut:    " -2.1 den geceyarısından itibaren",
},
      units: { perL: "den/L", perKg: "den/kg" },
      todayBadge:    "BUGÜN",
