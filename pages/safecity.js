...
export default function SafeCityPage() {
  ...
  const handleGpsToggle=()=>{
    ...
    if(!trackingActive){
      startTracking();
      setGpsHint(true);
      setTimeout(()=>setGpsHint(false),4000);
    } else {
      stopTracking();
      setGpsHint(false);
    }
          ...
          {!isMobile && (
            <div style={{position:"absolute",top:16,left:16,zIndex:500,background:"rgba(255,255,255,0.97)",backdropFilter:"blur(12px)",border:"1px solid #E8E5DE",borderRadius:14,padding:"16px 18px",maxWidth:280,boxShadow:"0 4px 20px rgba(0,0,0,0.1)"}}>
              ...
              <div style={{borderTop:"1px solid #E8E5DE",paddingTop:12,marginBottom:12}}>
                ...
                <button onClick={trackingActive?stopTracking:()=>{startTracking();setGpsHint(true);setTimeout(()=>setGpsHint(false),4000);}} style={{width:"100%",padding:"9px 12px",borderRadius:9,cursor:"pointer",fontFamily:"inherit",fontSize:13,fontWeight:700,textAlign:"left",display:"flex",alignItems:"center",justifyContent:"space-between",background:trackingActive?"#F0FDF4":"#F5F4F1",border:`1px solid ${trackingActive?"#86EFAC":"#E8E5DE"}`,color:trackingActive?"#15803D":"#4A4640",transition:"all 0.15s",marginBottom:6}}>
